...
{
    [Route("api/truckworkshops")]
    [ApiController]
    public class TruckWorkshopAPIController : ControllerBase
    {
        private ITruckWorkshopRepository truckWorkshop; 

        public TruckWorkshopAPIController(ITruckWorkshopRepository truckWorkshop)
        {
